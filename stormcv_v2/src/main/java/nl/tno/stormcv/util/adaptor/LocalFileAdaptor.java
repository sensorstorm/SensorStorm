...
public class LocalFileAdaptor implements FileAdaptor{
	...
	public InputStream getAsStream() throws IOException{
		//return new FileInputStream(localLocation);
		return null;
	}

	@Override
	public LocalFileAdaptor setExtensions(String[] extensions) {
	...
	public FileAdaptor deepCopy() {
		FileAdaptor fl = new LocalFileAdaptor();
